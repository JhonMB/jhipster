...
describe('JobHistory e2e test', () => {
  ...
  it('should load JobHistories', async () => {
    ...
    expect(await jobHistoryComponentsPage.getTitle()).to.eq('almacenApp.jobHistory.home.title');
  });
  ...
  it('should load create JobHistory page', async () => {
    ...
    expect(await jobHistoryUpdatePage.getPageTitle()).to.eq('almacenApp.jobHistory.home.createOrEditLabel');
  ...
  it('should delete last JobHistory', async () => {
    ...
    expect(await jobHistoryDeleteDialog.getDialogTitle()).to.eq('almacenApp.jobHistory.delete.question');
